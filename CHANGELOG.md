...
- Added setting for waveform CRT glow effect
- Update wellen to 0.24.0
  - Automatically combine bit vectors from array of single bit signals (usually seen in VCDs generated by questa)
